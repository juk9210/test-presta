...
public class HomePage extends AbstractWaits {
    ...
    public boolean currencyCheckOnThePage(Currency currency) {
        ...
        AbstractProperties.log( "Check that the currency of the goods is set correctly" );
        switch (currency) {
            case EUR:
            ...
            case USD:
                ...
                return true;
            default:
                throw new IllegalArgumentException( "Wrong currency entered" );
        }
    }
